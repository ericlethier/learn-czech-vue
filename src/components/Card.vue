    ...
    <article class="notification is-primary shadow-box" style="margin-bottom:10px; padding-right:20px; padding-left:20px;">
      ...
      <p class="content">
        <div class=" has-text-centered">
          <h1 class="title is-1">{{ currentCard.front }}</h1>
          <h2 class="title is-2" v-show="show" style="font-style: oblique;">{{ currentCard.back }}</h3>
        </div>
      </p>
      <hr/>
...
<script>
  ...
  export default {
    ...
    props: ['cardListTitle', 'isLastCard', 'counter', 'cardListSize'],
